...
public class DM_Tab_1Activity extends TabActivity implements OnTabChangeListener {
    ...
    private void initTabs() {
        ...
        tabHost.addTab(tabHost.newTabSpec("photo").setIndicator(createTabView(PHOTO))
                .setContent(new Intent(this, DM_TopicActivity.class)));

        tabHost.addTab(tabHost.newTabSpec("subscribe").setIndicator(createTabView(SUBSCRIBE))
                .setContent(new Intent(this, DM_SubActivity.class)));
