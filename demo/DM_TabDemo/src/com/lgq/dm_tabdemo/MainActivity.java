...
public class MainActivity extends TabActivity {
    ...
    private void initTabs() {
        ...
        tabHost.addTab(tabHost.newTabSpec("xinwen")
                .setIndicator("dd", getResources().getDrawable(R.drawable.icon_favorite))
                .setContent(new Intent(this, NewsActivity.class)));

        tabHost.addTab(tabHost.newTabSpec("xinwen").setIndicator("", null)
        ...
        tabHost.getTabWidget().getChildAt(0)
                .setBackgroundDrawable(getResources().getDrawable(R.drawable.news));
        tabHost.getTabWidget().getChildAt(1)
                .setBackgroundDrawable(getResources().getDrawable(R.drawable.topic));
        tabHost.getTabWidget().getChildAt(2)
                .setBackgroundDrawable(getResources().getDrawable(R.drawable.dingyue));
        tabHost.getTabWidget().getChildAt(3)
                .setBackgroundDrawable(getResources().getDrawable(R.drawable.shoucang));
